...
def main():
    ...
    # model = YOLO(
    #     "/home/ros-industrial/ros2_ws/src/fruit_detection/fruit_detection/v8-v9-0917.onnx")
    ...
    while True:
        ...
        # halfの効果はあまりない imgszは640以外だとエラーが出る
        results = model(img, stream=True, half=True, imgsz=640, show=False)
