...
Xmove_Controller_Node::Xmove_Controller_Node() : rclcpp::Node("Xmove_Controller")
{
    ...
    this->JoySubscription = this->create_subscription<sensor_msgs::msg::Joy>("joy2", rclcpp::QoS(10), std::bind(&Xmove_Controller_Node::Joy_Callback, this, std::placeholders::_1));
