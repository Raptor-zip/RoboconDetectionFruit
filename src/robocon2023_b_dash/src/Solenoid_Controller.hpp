...
private:
    ...
    void KiwiotionOut_Callback(const std_msgs::msg::ByteMultiArray::SharedPtr md_msg);   // 1 data

    rclcpp::Publisher<std_msgs::msg::ByteMultiArray>::SharedPtr Solenoid_Controller_publisher;

    ABU2023_GenericOutput_Header_Typedef Solenoid_Controll_msg, WallMotion_msg, RopeMotion_msg, KiwiMotion_msg;
