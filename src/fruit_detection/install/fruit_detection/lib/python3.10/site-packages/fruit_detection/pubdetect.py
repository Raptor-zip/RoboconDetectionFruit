    ...
    while True:
        ...
        for r in results:
            ...
            if len(boxes) == 1:
                ...
                # print("aaaaaaaaaaaaabbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb")
                print("frui arrayyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyy")
                if len(fruit_array) == 0:
                    # y wo hikakusuur
                    print(len(fruit_array_all)-1) # 1
