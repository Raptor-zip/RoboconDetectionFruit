...
<<<<<<< HEAD
scrcpy --v4l2-sink=/dev/video9 -m 1000 --max-fps=60 --window-x=100 --always-on-top --lock-video-orientation=2  #gamen haten
=======
scrcpy --v4l2-sink=/dev/video9 -m 1000 --max-fps=60 --window-x=100 --always-on-top  #gamen haten
>>>>>>> origin/master
